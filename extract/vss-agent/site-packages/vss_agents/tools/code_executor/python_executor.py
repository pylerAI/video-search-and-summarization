...
async def python_executor(config: CodeExecutorConfig, _builder: Builder) -> AsyncGenerator[FunctionInfo]:
    ...
    async def _python_executor(code_executor_input: CodeExecutorInput) -> dict[str, str]:
        """
        ...
        """
        output = executor.run_code(code_executor_input.code, code_executor_input.files, image=image_name)
