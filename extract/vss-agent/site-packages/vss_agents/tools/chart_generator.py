...
def plot_bar_chart(bar_chart_data: BarChartData):
    """
...
def plot_pie_chart(pie_chart_data: PieChartData):
    """
...
async def chart_generator(config: ChartGeneratorConfig, builder: Builder):
