...
class DuckDBIncidentsManager:
    ...
    async def load_incidents_from_bucket(self):
    ...
    def get_schema(self):
        return self.conn.execute("DESCRIBE incidents").fetchall()


@register_function(config_type=VARetrievalConfig, framework_wrappers=[LLMFrameworkEnum.LANGCHAIN])
async def va_retrieval(config: VARetrievalConfig, _builder: Builder):
    """
