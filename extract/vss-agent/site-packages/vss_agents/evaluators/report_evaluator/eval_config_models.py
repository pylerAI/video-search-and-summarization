...
class FieldConfig(BaseModel):
    ...
    method: Optional[str] = Field(default=None, description="Evaluation method to use.")
    fields: Optional[Dict[str, "FieldConfig"]] = Field(
        default=None,
    ...
    def validate_and_collect_methods(self):
