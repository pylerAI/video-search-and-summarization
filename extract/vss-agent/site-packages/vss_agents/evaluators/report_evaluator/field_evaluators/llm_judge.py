...
class FieldEvaluation(BaseModel):
    ...
    reference_field: Optional[str] = Field(None, description="Matched reference field name. If no match, set to None.")
...
class LLMJudgeMetric(EvaluationMetric):
    ...
    def __init__(self, **kwargs):
        ...
        if llm_kwargs:
            ...
            self.llm = self.llm.bind(**llm_kwargs)
    ...
    async def evaluate(self, actual: Any, reference: Any, field_name: str = "") -> Optional[float]:
        """
    ...
    async def evaluate_with_field_discovery(
        ...
        try:
            ...
            if result is None:
                logger.error("Structured output returned None. ")
                return {field_name: None for field_name in unspecified_fields}
