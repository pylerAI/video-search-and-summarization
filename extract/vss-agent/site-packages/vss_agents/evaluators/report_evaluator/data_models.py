...
class EvaluationScore(BaseModel):
    section_score: Optional[float] = Field(
    ...
    actual_value: Optional[Any] = Field(None, description="Actual generated value")
    reference_value: Optional[Any] = Field(None, description="Reference value")
    ...
    def from_error(
        ...
        field_scores: Optional[Dict[str, Optional["EvaluationScore"]]] = None,
    ) -> "EvaluationScore":
