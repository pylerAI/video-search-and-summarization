...
class Incident(BaseModel):
    """
    Incident model mapping to NVschema incident.
    https://gitlab-master.nvidia.com/metromind/mdat/nv-schema/-/blob/main/src/main/protobuf/ext.proto?ref_type=heads
