...
class FramesQueryBuilder:
    ...
    @staticmethod
    def fov_histogram_aggregation(bucket_size_sec: int, object_type: Optional[str] = None) -> Dict:
        """
        ...
        if object_type:
            agg["eventsOverTime"]["aggs"]["fov"]["aggs"]["searchAggFilter"]["filter"]["bool"]["filter"].append(
