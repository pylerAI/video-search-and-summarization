LICENSE AGREEMENT FOR NVIDIA METROPOLIS MICROSERVICES EVALUATION
...
2.3 You may not reverse engineer, decompile, or disassemble the SOFTWARE components provided in binary form, nor attempt in any other manner to obtain source code of such SOFTWARE.
...
Limitations of Liability. TO THE FULLEST EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT WILL NVIDIA BE LIABLE FOR ANY (I) INDIRECT, PUNITIVE, SPECIAL, INCIDENTAL OR CONSEQUENTIAL DAMAGES, OR (II) DAMAGES FOR THE (A) COST OF PROCURING SUBSTITUTE GOODS OR (B) LOSS OF PROFITS, REVENUES, USE, DATA OR GOODWILL ARISING OUT OF OR RELATED TO THIS AGREEMENT, WHETHER BASED ON BREACH OF CONTRACT, TORT (INCLUDING NEGLIGENCE), STRICT LIABILITY, OR OTHERWISE, AND EVEN IF NVIDIA HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES AND EVEN IF A PARTY'S REMEDIES FAIL THEIR ESSENTIAL PURPOSE.
...
This software includes dynamically linked open source libraries in its Docker runtime for PDF generation functionality. These libraries are not modified and are used in accordance with their respective licenses:

### LGPL 2.1+ Licensed Libraries

The following libraries are licensed under the GNU Lesser General Public License (LGPL) version 2.1 or later. These libraries are dynamically linked and users may replace them with compatible versions:

- **Cairo** - 2D graphics library (https://www.cairographics.org/)
  - License: LGPL 2.1 or MPL 1.1
  - Used for PDF rendering

- **Pango** - Text layout and rendering library (https://pango.gnome.org/)
  - License: LGPL 2.1+
  - Used for text layout in PDFs

- **GLib** - Low-level core library (https://gitlab.gnome.org/GNOME/glib)
  - License: LGPL 2.1+
  - Core library dependency

- **GObject** - Object system library (part of GLib)
  - License: LGPL 2.1+
  - Core library dependency

- **GdkPixbuf** - Image loading library (https://gitlab.gnome.org/GNOME/gdk-pixbuf)
  - License: LGPL 2.1+
  - Used for image handling in PDFs

### MIT and BSD-Style Licensed Libraries

- **HarfBuzz** - Text shaping library (https://harfbuzz.github.io/)
  - License: MIT License

- **libffi** - Foreign Function Interface library (https://sourceware.org/libffi/)
  - License: MIT License

- **Fontconfig** - Font configuration library (https://www.freedesktop.org/wiki/Software/fontconfig/)
  - License: MIT-style License

- **FreeType** - Font rendering library (https://www.freetype.org/)
  - License: FreeType License (BSD-style) or GPL v2

### License Compliance

All LGPL libraries are dynamically linked (as shared objects) and are not modified. Users of this software have the right to:
1. Replace the LGPL libraries with compatible versions
2. Obtain the source code for these libraries from their respective upstream repositories

For the full text of the LGPL 2.1 license, visit: https://www.gnu.org/licenses/old-licenses/lgpl-2.1.html

For the full text of the MIT license, visit: https://opensource.org/licenses/MIT