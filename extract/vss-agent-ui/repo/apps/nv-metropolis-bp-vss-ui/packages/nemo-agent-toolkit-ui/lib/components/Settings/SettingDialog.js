...
export const SettingDialog = ({ open, onClose })=>{
    ...
    const { state: { lightMode, chatCompletionURL, webSocketURL, webSocketSchema: schema, expandIntermediateSteps, intermediateStepOverride, enableIntermediateSteps, webSocketSchemas }, dispatch: homeDispatch } = homeContext;
    ...
    return /*#__PURE__*/ _jsx("div", {
        className: "fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm z-50 dark:bg-opacity-20",
        children: /*#__PURE__*/ _jsxs("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ _jsx("label", {
                    ...
                    children: t('HTTP URL for Chat Completion')
                }),
                /*#__PURE__*/ _jsx("input", {
                    type: "text",
                    value: chatCompletionEndPoint,
                ...
                /*#__PURE__*/ _jsx("label", {
                    className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mt-4",
                    children: t('WebSocket URL for Chat Completion')
                }),
                /*#__PURE__*/ _jsx("input", {
                    type: "text",
                    value: webSocketEndPoint,
                ...
                /*#__PURE__*/ _jsx("select", {
                    ...
                    children: webSocketSchemas?.map((schema)=>/*#__PURE__*/ _jsx("option", {
                            value: schema,
                            children: schema
                        }, schema))
                }),
                /*#__PURE__*/ _jsxs("div", {
                    className: "flex align-middle text-sm font-medium text-gray-700 dark:text-gray-300 mt-4",
                    children: [
                        /*#__PURE__*/ _jsx("input", {
                            type: "checkbox",
                        ...
                        /*#__PURE__*/ _jsx("label", {
                            ...
                            children: "Enable Intermediate Steps"
                        })
                    ]
                }),
                /*#__PURE__*/ _jsxs("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ _jsx("label", {
                            ...
                            className: "text-sm font-medium text-gray-700 dark:text-gray-300",
                            children: "Expand Intermediate Steps by default"
                        })
                    ]
                }),
                /*#__PURE__*/ _jsxs("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ _jsx("label", {
                            ...
                            className: "text-sm font-medium text-gray-700 dark:text-gray-300",
                            children: "Override intermediate Steps with same Id"
                        })
                    ]
                }),
                /*#__PURE__*/ _jsxs("div", {
