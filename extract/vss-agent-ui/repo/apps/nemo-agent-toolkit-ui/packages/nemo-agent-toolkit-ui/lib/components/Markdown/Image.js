...
export const Image = /*#__PURE__*/ memo(({ src, alt, ...props })=>{
    ...
    if (src === 'loading') {
        return /*#__PURE__*/ _jsx("div", {
            className: "flex items-center justify-center p-8 bg-slate-50 rounded-lg border border-slate-200 min-h-[200px]",
    ...
    return /*#__PURE__*/ _jsx("span", {
        ...
        children: error ? /*#__PURE__*/ _jsxs("span", {
            className: "inline-flex items-center justify-center p-4 bg-slate-50 rounded-lg border border-slate-200",
            children: [
                /*#__PURE__*/ _jsx(IconExclamationCircle, {
            ...
            children: [
                ...
                !isLoaded && !error && /*#__PURE__*/ _jsx("div", {
                    className: "flex items-center justify-center p-8 bg-slate-50 rounded-lg border border-slate-200 min-h-[200px]",
                    children: /*#__PURE__*/ _jsxs("div", {
                        className: "text-center",
                        children: [
                ...
                isFullscreen && !error && isLoaded && /*#__PURE__*/ _jsx("div", {
                    className: "fixed inset-0 bg-black/95 flex items-center justify-center z-50",
                    onClick: toggleFullscreen,
                    onKeyDown: (e)=>e.key === 'Escape' && toggleFullscreen(e),
                    role: "dialog",
                    "aria-modal": "true",
                    tabIndex: -1,
