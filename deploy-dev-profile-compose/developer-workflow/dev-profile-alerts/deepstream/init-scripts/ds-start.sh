...
cp /opt/nvidia/deepstream/deepstream/sources/apps/sample_apps/metropolis_perception_app/models/rtdetr-its/resnet50_market1501.etlt /opt/nvidia/deepstream/deepstream-8.0/samples/models/Tracker/resnet50_market1501.etlt
...
if [[ $MODEL_NAME_2D == "GDINO" ]]; then
    ...
    cp /opt/storage/model_gdino_trt.plan /opt/nvidia/deepstream/deepstream-8.0/sources/TritonGdino/triton_model_repo/gdino_trt/1/model.plan
    ...
    GDINO_CONFIG_FILES=(
        "/opt/nvidia/deepstream/deepstream-8.0/sources/TritonGdino/triton_model_repo/ensemble_python_gdino/config.pbtxt"
        "/opt/nvidia/deepstream/deepstream-8.0/sources/TritonGdino/triton_model_repo/gdino_trt/config.pbtxt"
        "/opt/nvidia/deepstream/deepstream-8.0/sources/TritonGdino/triton_model_repo/gdino_postprocess/config.pbtxt"
        "/opt/nvidia/deepstream/deepstream-8.0/sources/TritonGdino/triton_model_repo/gdino_preprocess/config.pbtxt"
    )
